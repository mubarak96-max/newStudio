...
- shots: 1 to 4 illustrations that together cover the moment in order. Each is {"description" (one or two concrete visual sentences: setting, who is where, action, light; no text, captions or lettering in the image), "entityIds" (entities visible), "framing" (one of wide, medium, close, over-shoulder, insert), "mood" (one to three words), "timeOfDay" (dawn, day, dusk, night, interior, or unknown)}.
