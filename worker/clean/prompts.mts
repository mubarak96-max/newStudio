...
- kind: "body" for the book's prose, "heading" for a chapter or section heading, "frontmatter" for title pages, copyright, dedication, contents and publisher matter, "backmatter" for notes, index, appendix and colophon, "note" for page furniture, "caption" for an illustration caption.
