...
export const imageModel =
  env.IMAGE_MODEL ?? "google/gemini-3.1-flash-lite-image";
 ...
 */
export const geminiInputUsdPerToken = envNumber(
  "GEMINI_INPUT_USD_PER_TOKEN",
  0.00000025,
  0,
);
export const geminiOutputUsdPerToken = envNumber(
  "GEMINI_IMAGE_OUTPUT_USD_PER_TOKEN",
  0.00003,
  0,
);
export const batchPollIntervalMs = envNumber(
...
export const workerVersion = "understand-v11";
